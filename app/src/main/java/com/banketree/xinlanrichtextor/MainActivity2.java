 ...
 */
public class MainActivity2 extends AppCompatActivity implements View.OnClickListener, ExpressionGridFragment.ExpressionClickListener, ExpressionGridFragment.ExpressionDeleteClickListener {
    ...
    public void onClick(View v) {
        switch (v.getId()) {
            ...
            case R.id.iv_emogi:
                ...
                String result = et_send_content.getText().toString();
