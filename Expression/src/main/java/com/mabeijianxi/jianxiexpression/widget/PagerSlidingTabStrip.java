...
public class PagerSlidingTabStrip extends HorizontalScrollView {
	...
	private int indicatorColor = 0xFF8DBF13;// 底部线的颜色:0xFFFF0000
	...
	private int scrollOffset = 32;// 52
	private int indicatorHeight = 2;// 8//底部线的高度
	private int underlineHeight = 1;// 2
	private int dividerPadding = 12;
	private int tabPadding = 14;// 24
	private int dividerWidth = 1;
	private int selectedTabTextColor = 0xFF8DBF13;//设置选择字体颜色。0xFFFF0000
	private int tabTextSize = 16;// 12
	private int tabTextColor = 0x55000000;
	private Typeface tabTypeface = null;
	private int tabTypefaceStyle = Typeface.NORMAL;// 设置字体
